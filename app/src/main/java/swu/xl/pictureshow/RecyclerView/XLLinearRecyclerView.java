...
public class XLLinearRecyclerView extends RecyclerView {
    //监听者
     ...
     * @param context
     */
    public XLLinearRecyclerView(@NonNull Context context) {
        super(context);
     ...
     * @param attrs
     */
    public XLLinearRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    class MyAdapter extends RecyclerView.Adapter{
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            //加载布局
            View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.linear_item_layout, parent, false);
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
            ...
            //设置点击事件
            myViewHolder.icon_view.setOnClickListener(new View.OnClickListener() {
                @Override
